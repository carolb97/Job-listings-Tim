...
export class JobListingsComponent implements OnInit {
	...
	getAllAttributes(element: IJob): any[] {
		//document.write(element.logo.toString());
		return [element.company, element.logo, element.new, element.featured,
			element.position,element.postedAt,element.contract,element.location]
...
export class JobListingsDetails {
void()
//write job listing details
}*/
